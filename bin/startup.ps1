...
function downloadJava()
{
    ...
    $JavaVersion = "21.0.4"
    $JavaRevision = "7"
    $JavaFileURL = "https://github.com/adoptium/temurin21-binaries/releases/download/jdk-${JavaVersion}%2B${JavaRevision}/OpenJDK21U-jdk_x64_windows_hotspot_${JavaVersion}_${JavaRevision}.zip"
