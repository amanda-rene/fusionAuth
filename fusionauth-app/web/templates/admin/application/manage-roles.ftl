          ...
          <tbody>
            [#list application.roles as role]
              <tr>
                ...
                <td class="action">
                  [@button.actionMenu]
                    [@button.actionMenuItem href="/ajax/application/edit-role?applicationId=${applicationId}&roleId=${role.id}" icon="edit" textKey="edit" ajaxView=false ajaxForm=true ajaxWideDialog=true/]
                    [@button.actionMenuItem href="/ajax/application/delete-role?applicationId=${applicationId}&roleId=${role.id}" icon="trash" textKey="delete" ajaxView=false ajaxForm=true/]
                  [/@button.actionMenu]
                </td>
              </tr>
            [#else]
