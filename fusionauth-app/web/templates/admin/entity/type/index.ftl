            ...
            <table class="hover listing" data-sortable="false">
              ...
              [#list results![] as result]
                <tr>
                  ...
                  <td class="action">
                    [@button.actionMenu]
                      [@button.actionMenuItem href="/admin/entity/type/edit/${result.id}" icon="edit" textKey="edit"/]
                      [@button.actionMenuItem href="/admin/entity/type/permission/?entityTypeId=${result.id}" icon="key" textKey="manage-permissions"/]
                      [@button.actionMenuItem href="/ajax/entity/type/view/${result.id}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true/]
                      [@button.actionMenuItem href="/admin/entity/type/delete/${result.id}" icon="trash" textKey="delete"/]
                    [/@button.actionMenu]
                  </td>
                </tr>
              [#else]
