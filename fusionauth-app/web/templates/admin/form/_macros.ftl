  ...
  <fieldset class="form-row mt-4" >
    ...
    <table id="form-step-table" class="mt-4" data-template="form-step-row-template" data-add-button="form-step-add-button" data-delete-button=".step-delete">
      ...
      <tbody>
       ...
       [#list form.steps as step]
        <tr class="step-row">
              ...
              <table data-template="form-field-row-template" data-delete-button=".field-delete">
                 ...
                 <tbody>
                   ...
                   <tr class="field-row">
                     ...
                     <td class="action">
                        [@button.iconLinkWithText href="#" icon="trash" color="red" textKey="delete" class="field-delete"/]
                     </td>
                   </tr>
                   [/#list]
                 </tbody>
          ...
          <td class="action top">
            [@button.iconLinkWithText href="#" icon="trash" color="red" textKey="delete" class="step-delete"/]
          </td>
        </tr>
        [/#list]
        </tbody>
      ...
      <script type="x-handlebars" id="form-step-row-template">
       ...
       <td class="action top">[@button.iconLinkWithText href="#" icon="trash" color="red" textKey="delete" class="step-delete"/]</td>
       </tr>
      </script>
      [#-- Form Field Template --]
      <script type="x-handlebars" id="form-field-row-template">
       <tr class="field-row">
         ...
         <td class="action">[@button.iconLinkWithText href="#" icon="trash" color="red" textKey="delete" class="field-delete"/]</td>
       </tr>
      </script>
     <div class="mt-5">
