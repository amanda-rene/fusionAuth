      ...
      <fieldset>
        ...
        <table id="acl-entries-table" class="u-small-bottom-margin" data-template="acl-entry-row-template" data-add-button="acl-entry-add-button">
          ...
          <tr class="empty-row">
            ...
            <tr class="form-controls">
              ...
              <td class="action">[@button.iconLinkWithText href="#" icon="trash" textKey="delete" color="red" class=defaultRule?then("disabled", "delete-button")/]</td>
            </tr>
            [/#list]
          </tbody>
        </table>
        <script type="x-handlebars" id="acl-entry-row-template">
          <tr class="form-controls">
            ...
            <td class="action">[@button.iconLinkWithText href="#" icon="trash" textKey="delete" class="delete-button" color="red"/]</a>
          </tr>
        </script>
