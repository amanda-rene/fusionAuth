      ...
      [#list messengers![] as messenger]
        <tr>
          ...
          <td class="action">
            ...
            [@button.actionMenu]
              [@button.actionMenuItem href="edit/${messenger.type}/${messenger.id}" icon="edit" textKey="edit"/]
              [@button.actionMenuItem href="add/${messenger.type}?messengerId=${messenger.id}" icon="copy" textKey="duplicate"/]
              [@button.actionMenuItem href="/ajax/messenger/view/${messenger.id}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true resizeDialog=true/]
              [@button.actionMenuItem href="delete/${messenger.id}" icon="trash" textKey="delete"/]
            [/@button.actionMenu]
          </td>
        </tr>
      [#else]
          ...
          <table id="header-table" class="u-small-bottom-margin" data-template="header-row-template" data-add-button="header-add-button">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="action">[@button.iconLinkWithText href="#" color="red" icon="trash" textKey="delete" class="delete-button"/]</td>
              </tr>
              [/#list]
            </tbody>
          </table>
