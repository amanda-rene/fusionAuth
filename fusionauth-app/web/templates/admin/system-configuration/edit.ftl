...
[#import "../theme/_macros.ftl" as themeMacros/]
  ...
  [@layout.body]
    [@layout.pageForm action="edit" method="POST" id="applications-form" includeSave=true cancelURI="/admin/" breadcrumbs={"": "settings", "/admin/system-configuration/edit": "system"}]
      <ul id="tabs" class="tabs">
        ...
        <li><a href="#network-settings">[@message.print key="networking"/]</a></li>
      ...
      <div id="ui-settings" class="hidden">
        <fieldset>
          ...
          [@themeMacros.colorPicker
            key="header-color"
            name="systemConfiguration.uiConfiguration.headerColor"
            value="${systemConfiguration.uiConfiguration.headerColor!''}"
            label="${function.message('systemConfiguration.uiConfiguration.headerColor')}"
            tooltip="${function.message('{tooltip}systemConfiguration.uiConfiguration.headerColor')}"
            includeFormRow=true
          /]
          [@themeMacros.colorPicker
            key="menu-font-color"
            name="systemConfiguration.uiConfiguration.menuFontColor"
            value="${systemConfiguration.uiConfiguration.menuFontColor!''}"
            label="${function.message('systemConfiguration.uiConfiguration.menuFontColor')}"
            tooltip="${function.message('{tooltip}systemConfiguration.uiConfiguration.menuFontColor')}"
            includeFormRow=true
          /]
        </fieldset>
      </div>
      ...
      <div id="network-settings" class="hidden">
        <fieldset>
          <legend>[@message.print key="ip-address-resolution-settings"/]</legend>
          <p><em>[@message.print key="ip-address-resolution-settings-description"/]</em></p>
          [@control.select items=trustPolicies name="systemConfiguration.trustedProxyConfiguration.trustPolicy"/]
          [@control.textarea name="trustedProxies" labelKey="systemConfiguration.trustedProxyConfiguration.trusted" wideTooltip=function.message('{tooltip}systemConfiguration.trustedProxyConfiguration.trusted')/]
        </fieldset>
      </div>
      ...
      <div id="advanced" class="hidden">
        ...
        <fieldset>
          <legend>[@message.print key="webhook-event-log-settings"/]</legend>
             [@control.checkbox name="systemConfiguration.webhookEventLogConfiguration.delete.enabled" value="true" uncheckedValue="false" data_slide_open="webhook-event-log-delete-settings" tooltip=function.message('{tooltip}systemConfiguration.webhookEventLogConfiguration.delete.enabled')/]
           <div id="webhook-event-log-delete-settings" class="slide-open [#if (systemConfiguration.webhookEventLogConfiguration.delete.enabled)!false]open[/#if]">
             [@control.text name="systemConfiguration.webhookEventLogConfiguration.delete.numberOfDaysToRetain" rightAddonText="${function.message('DAYS')}" required=true tooltip=function.message('{tooltip}systemConfiguration.webhookEventLogConfiguration.delete.numberOfDaysToRetain')/]
           </div>
        </fieldset>
      </div>
    [/@layout.pageForm]
