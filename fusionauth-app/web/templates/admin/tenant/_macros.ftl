...
[#-- @ftlvariable name="loginValidationLambdas" type="java.util.List<io.fusionauth.domain.Lambda>" --]
...
[#-- @ftlvariable name="scimGroupRequestLambdas" type="java.util.List<io.fusionauth.domain.Lambda>" --]
[#-- @ftlvariable name="scimGroupResponseLambdas" type="java.util.List<io.fusionauth.domain.Lambda>" --]
[#-- @ftlvariable name="scimUserRequestLambdas" type="java.util.List<io.fusionauth.domain.Lambda>" --]
[#-- @ftlvariable name="scimUserResponseLambdas" type="java.util.List<io.fusionauth.domain.Lambda>" --]
...
[#macro connectorConfiguration]
          ...
          <tr class="connector-policy" data-connector-id="${connectorPolicy.connectorId}">
            ...
            <td class="action">
              [#if !fusionAuthConnector]
                [@button.actionMenu]
                  [@button.actionMenuItem href="/ajax/tenant/connector-policy/edit" icon="pencil" textKey="edit" class="edit-button"/]
                  [@button.actionMenuItem href="#" icon="trash" textKey="delete" class="delete-button"/]
                [/@button.actionMenu]
              [/#if]
            </td>
          </tr>
  ...
  <script type="x-handlebars" id="connector-policy-row-template">
    <tr class="connector-policy" data-connector-id="{{connectorId}}">
      ...
      <td class="action">
       [@button.actionMenu]
         [@button.actionMenuItem href="/ajax/tenant/connector-policy/edit" icon="pencil" color="blue" textKey="edit" class="edit-button"/]
         [@button.actionMenuItem href="#" icon="trash" textKey="delete" class="delete-button"/]
       [/@button.actionMenu]
      </td>
    </tr>
...
[#macro advancedConfiguration]
  <fieldset>
    ...
    [@control.text name="tenant.externalIdentifierConfiguration.loginIntentTimeToLiveInSeconds" title="${helpers.approximateFromSeconds(tenant.externalIdentifierConfiguration.loginIntentTimeToLiveInSeconds)}" rightAddonText="${function.message('SECONDS')}" required=true tooltip=function.message('{tooltip}tenant.externalIdentifierConfiguration.loginIntentTimeToLiveInSeconds')/]
    ...
    [@control.text name="tenant.externalIdentifierConfiguration.rememberOAuthScopeConsentChoiceTimeToLiveInSeconds" title="${helpers.approximateFromSeconds(tenant.externalIdentifierConfiguration.rememberOAuthScopeConsentChoiceTimeToLiveInSeconds)}" rightAddonText="${function.message('SECONDS')}" required=true tooltip=function.message('{tooltip}tenant.externalIdentifierConfiguration.rememberOAuthScopeConsentChoiceTimeToLiveInSeconds')/]
...
[#macro emailConfiguration action includeAdvancedOptions=true includeVerification=true includeTemplates=true]
  <fieldset>
    <legend>[@message.print key="smtp-settings"/]</legend>
  ...
  [#if includeTemplates]
    <fieldset>
      ...
      <p>
        <em>[@message.print key="{description}template-settings"/]</em>
      </p>
...
<div class="mb-4">
  ...
  [@message.freeLicenseFeatureAlert alertMessageKey="{free-license-feature}webauthn" fieldName="tenant.webAuthnConfiguration.enabled" errorCode="[notLicensed]tenant.webAuthnConfiguration.enabled"/]
</div>
<p class="mt-0 mb-4">
...
[#macro securityConfiguration]
  <fieldset>
    ...
    [@control.select name="tenant.lambdaConfiguration.loginValidationId" items=loginValidationLambdas![] required=false valueExpr="id" textExpr="name" headerValue="" headerL10n="none-selected-lambda-disabled" tooltip=function.message("{tooltip}tenant.lambdaConfiguration.loginValidationId")/]
  </fieldset>
  <fieldset>
