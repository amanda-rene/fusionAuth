  ...
  <div class="row h-100 theme-preview">
    ...
    [#list templates as template]
      <div id="${template}" class="vertical-tab hidden">
        <div>
          [#-- Note, ideally we would only add parameters when we know we are rendering that template. --]
          ...
          + (template == "confirmationRequired")?then("&confirmationRequiredReason=${confirmationRequiredReason}", "")
          /]
        ...
        <div class="mt-4">
            [@control.form action="view" method="GET" class="full labels-left"]
               ...
               [#elseif template == "confirmationRequired"]
                 <div class="row">
                   <div class="col-xs-6 col-md-6 col-lg-6 col-xl-12">
                     [@control.select items=availableConfirmationRequiredReasons name="confirmationRequiredReason" selected=confirmationRequiredReason/]
                   </div>
                 </div>
               [/#if]
            [/@control.form]
