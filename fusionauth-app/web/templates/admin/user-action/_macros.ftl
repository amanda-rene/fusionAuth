    ...
    <fieldset>
        ...
        <tr class="empty-row">
          ...
          <tr>
            ...
            <td class="action">
              ...
              [/#list]
              [@button.actionMenu]
                [@button.actionMenuItem href="/ajax/user-action/validate-option?${params}" icon="edit" textKey="edit" ajaxWideDialog=true ajaxForm=true/]
                [@button.actionMenuItem href="#" icon="trash" textKey="delete" class="delete-button" ajaxForm=true/]
              [/@button.actionMenu]
            </td>
          </tr>
          [/#list]
      ...
      <script id="option-template" type="text/x-handlebars-template">
        <tr>
          ...
          <td class="action">
            [@button.actionMenu]
              [@button.actionMenuItem href="/ajax/user-action/validate-option?name={{name}}{{#each localizedNames as |name locale|}}&localizedNames['{{locale}}']={{name}}{{/each}}" icon="edit" textKey="edit" ajaxWideDialog=true ajaxForm=true/]
              [@button.actionMenuItem href="#" icon="trash" textKey="delete" class="delete-button" ajaxForm=true/]
            [/@button.actionMenu]
          </td>
        </tr>
    ...
    <fieldset>
      ...
      <script id="localization-template" type="text/x-handlebars-template">
        <tr>
          ...
          <td class="action">[@button.iconLinkWithText icon="trash" color="red" textKey="delete" class="delete-button" href="#"/]</td>
        </tr>
      </script>
    </fieldset>
  </div>
    ...
    [#if userActions?? && userActions?size > 0]
      ...
      <tr>
        ...
        <td class="action">
          [@button.actionMenu]
            [#if deactivated]
              [@button.actionMenuItem href="/ajax/user-action/reactivate/${userAction.id}" icon="plus-circle" textKey="reactivate" ajaxForm=true/]
              [@button.actionMenuItem href="../delete/${userAction.id}" icon="trash" textKey="delete"/]
            [#else]
              [@button.actionMenuItem href="edit/${userAction.id}" icon="edit" textKey="edit"/]
              [@button.actionMenuItem href="/ajax/user-action/view/${userAction.id}" icon="search" textKey="view" ajaxView=true  ajaxWideDialog=true/]
              [@button.actionMenuItem href="/ajax/user-action/deactivate/${userAction.id}" icon="minus-circle" textKey="deactivate" ajaxForm=true/]
              [@button.actionMenuItem href="delete/${userAction.id}" icon="trash" textKey="delete"/]
            [/#if]
          [/@button.actionMenu]
        </td>
