          ...
          <tbody>
            [#list reasons![] as userActionReason]
              <tr>
                ...
                <td class="action">
                  [@button.actionMenu]
                    [@button.actionMenuItem href="edit/${userActionReason.id}" icon="edit" textKey="edit"/]
                    [@button.actionMenuItem href="/ajax/user-action/reason/view/${userActionReason.id}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true/]
                    [@button.actionMenuItem href="/ajax/user-action/reason/delete/${userActionReason.id}" icon="trash" textKey="delete" ajaxForm=true/]
                  [/@button.actionMenu]
                </td>
              </tr>
            [#else]
