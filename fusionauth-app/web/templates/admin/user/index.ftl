      ...
      [@layout.pageHeader breadcrumbs={"/admin/user/": "users"}]
        ...
        [#else]
          ...
          <div class="bulk-actions inline-block" style="margin-left: 3px;">
            ...
            [@button.ajaxLink href="/ajax/group/member/add?csrfToken=${csrfToken}&bulkManagement=true" color="blue" icon="plus-circle" tooltipKey="add-to-group" additionalClass="square button disabled" ajaxForm=true ajaxWideDialog=true/]
            [@button.ajaxLink href="/ajax/group/member/remove?csrfToken=${csrfToken}&bulkManagement=true" color="orange" icon="minus-circle" tooltipKey="remove-from-group" additionalClass="square button disabled" ajaxForm=true ajaxWideDialog=true/]
          </div>
        [/#if]
      [/@layout.pageHeader]
