...
<fieldset>
  ...
  [@control.text name="role.name" autocapitalize="none" autocomplete="off" autocorrect="off" autofocus="autofocus" disabled=true tooltip=function.message('{tooltip}nameReadOnly')/]
