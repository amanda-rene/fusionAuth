  ...
  [#list results![] as result]
    <tr>
      ...
      <td class="action">
        [#if !readOnly]
          [@button.actionMenu]
            [@button.actionMenuItem href="/admin/entity/grant/upsert?entityId=${result.entity.id}&grant.userId=${result.userId!''}&grant.recipientEntityId=${result.recipientEntityId!''}&tenantId=${result.entity.tenantId}" icon="edit" textKey="edit"/]
            [@button.actionMenuItem href="/ajax/entity/grant/delete?entityId=${result.entity.id}&userId=${result.userId!''}&recipientEntityId=${result.recipientEntityId!''}" icon="trash" textKey="delete" ajaxForm=true/]
          [/@button.actionMenu]
        [/#if]
      </td>
    </tr>
