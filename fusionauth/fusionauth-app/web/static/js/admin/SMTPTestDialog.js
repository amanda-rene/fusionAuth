...
/**
 * NOTE: This class is used by the FirstTimeSetup as well, so changes need to be verified there as well.
 *
 * @constructor
 */
FusionAuth.Admin.SMTPTestDialog = function(form, smtpEditor) {
  Prime.Utils.bindAll(this);

  this.form = form;
  this.smtpEditor = smtpEditor;
