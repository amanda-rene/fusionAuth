...
[#ftl/]
[#-- @ftlvariable name="customHeaderColor" type="java.lang.String" --]
[#-- @ftlvariable name="customMenuFontColor" type="java.lang.String" --]
...
[#-- @ftlvariable name="showAnnouncement" type="java.lang.Boolean" --]
...
<head>
  ...
  [#-- Handlebars --]
  <script src="${request.contextPath}/js/handlebars.min-v4.7.8.js"></script>
  ...
  <script src="${request.contextPath}/js/admin/ActionMenu.js?version=${version}"></script>
  ...
  <script src="${request.contextPath}/js/admin/LicenseCta.js?version=${version}"></script>
  ...
  <script src="${request.contextPath}/js/admin/ManageWebhookEventLog.js?version=${version}"></script>
  ...
  <script src="${request.contextPath}/js/ui/CopyToClipboard-0.1.0.js"></script>
  ...
  <style>
      ...
      body .app-sidebar .footer-container {
        background: ${customHeaderColor};
      }
      body .app-sidebar nav ul li a:hover, body .app-sidebar nav ul li a.active, body .app-sidebar nav ul li.folder.open a:not(.active):hover {
...
<body class="${bodyClass}">
  [#if ftlCurrentUser?? && zoneId??]
    <div class="app-sidebar">
      ...
      <nav>
        <ul class="treeview [#if showAnnouncement!false]announcement-active[/#if]">
          ...
          [#-- First time setup --]
          [#if !instance.firstTimeSetup.complete]
            [@navigationButton icon="magic" nameKey="first-time-setup" path="/admin/first-time-setup" roles=["admin"] /]
          [/#if]
          ...
          [@navigationNode icon="desktop" nameKey="system"
            ...
            [@navigationLeafNode path="/admin/system/webhook-event-log/" icon="rss" nameKey="webhook-event-log" roles=["admin", "webhook_event_log_viewer"] children=["/admin/system/webhook-event-log/"]/]
      ...
      [#if showAnnouncement!false]
        <div class="announcement-container">
          <a id="dismiss-license-cta" href="/ajax/announcement/license-cta/dismiss" class="float-right"><img src="/images/announcement/announcement-dismiss.svg" alt="Announcement Dismiss"/></a>
          <div class="announcement-icon">
            <img src="/images/announcement/announcement-icon.svg" alt="Announcement Icon"/>
          </div>
          <div class="announcement-content">
            <h5>${function.message('license-cta-content')}</h5>
            <a href="/admin/reactor/" class="blue button square">${function.message('license-cta-button')}</a>
          </div>
        </div>
      [/#if]
...
[#macro pageHeader titleKey="page-title" includeAdd=false includeBack=false includeCancel=false includeSave=false includeDelete=false nestedFirst=false addURI="add" backURI="" cancelURI="" deleteURI="" saveColor="blue" saveKey="save" saveIcon="save" breadcrumbs={}]
