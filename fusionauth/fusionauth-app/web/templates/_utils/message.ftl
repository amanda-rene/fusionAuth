...
[#macro freeLicenseFeatureAlert alertMessageKey fieldName errorCode]
  [#if fieldMessages[fieldName]?has_content]
    [#list fieldMessages[fieldName] as e]
      [#if e.code.equals(errorCode)]
        [@alert message=inline(alertMessageKey) type="free-license" icon="exclamation-triangle" includeDismissButton=false/]
      [/#if]
    [/#list]
  [/#if]
[/#macro]
