...
[#--
 ...
 --]
[#assign rowCount = 1/]
[#macro row nameKey value classes="" id="" copyable=false]
[#assign localId=id/]
[#if id == ""]
  [#assign localId="property-row-${rowCount}"/]
  [#assign rowCount++/]
[/#if]
<tr>
  <td class="top">
...
[#--
 ...
 --]
[#macro rowEval nameKey object propertyName="" booleanAsCheckmark=true booleanFalseAsX=false classes="" copyable=false]
  [@row nameKey=nameKey value=display(object, propertyName, "\x2013", booleanAsCheckmark, booleanFalseAsX) classes=classes copyable=copyable/]
[/#macro]
...
[#macro copyableValue value class="" attibutes=""]
  <div class="${class} d-flex" ${attibutes}>
    <span class="text-gray-500" style="flex-grow: 1;" id="copyable-${copyableId}">${value}</span>
    [#-- line-height inherit will match the span above so the icon is in the middle. --]
    <i class="fa fa-clone ml-2" style="cursor: pointer; line-height: inherit;" data-widget="copy-button" data-copy-source="copyable-${copyableId}" title="Click to copy" data-tooltip-value="Copied"></i>
    [#assign copyableId = copyableId + 1/]
  </div>
[/#macro]
