    ...
    <tbody>
      [#list connectors as connector]
        <tr>
          ...
          <td class="action">
            [@button.actionMenu]
              [@button.actionMenuItem href="/admin/connector/edit/${connector.type}/${connector.id}" icon="edit" textKey="edit"/]
              [@button.actionMenuItem href="/ajax/connector/view/${connector.id}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true resizeDialog=true/]
              [#if connector.id != fusionAuth.statics['io.fusionauth.domain.connector.BaseConnectorConfiguration'].FUSIONAUTH_CONNECTOR_ID]
                [@button.actionMenuItem href="/admin/connector/delete/${connector.id}" icon="trash" textKey="delete"/]
              [/#if]
            [/@button.actionMenu]
          </td>
        </tr>
