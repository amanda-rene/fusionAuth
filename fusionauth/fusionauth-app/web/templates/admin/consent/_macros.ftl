...
[#macro consentsTable]
  <table class="hover listing" data-sortable="false">
    ...
    [#list results![] as consent]
      <tr>
        <td class="break-word">${properties.display(consent, "name")}</td>
        <td class="hide-on-mobile">${properties.display(consent, "id")}</td>
        <td class="hide-on-mobile">${properties.display(consent, "values")}</td>
        <td class="action">
          [@button.actionMenu]
            [@button.actionMenuItem href="/admin/consent/edit/${consent.id}" icon="edit" textKey="edit"/]
            [@button.actionMenuItem href="/ajax/consent/view/${consent.id}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true resizeDialog=true/]
            [@button.actionMenuItem href="/admin/consent/delete/${consent.id}" icon="trash" textKey="delete"/]
          [/@button.actionMenu]
        </td>
      </tr>
    [#else]
