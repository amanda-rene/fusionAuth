          ...
          <tbody>
            [#list entityType.permissions as permission]
              <tr>
                ...
                <td class="action">
                  [@button.actionMenu]
                    [@button.actionMenuItem href="/ajax/entity/type/permission/edit?entityTypeId=${entityTypeId}&permissionId=${permission.id}" icon="edit" textKey="edit" ajaxView=false ajaxForm=true ajaxWideDialog=true/]
                    [@button.actionMenuItem href="/ajax/entity/type/permission/delete?entityTypeId=${entityTypeId}&permissionId=${permission.id}" icon="trash" textKey="delete" ajaxView=false ajaxForm=true/]
                  [/@button.actionMenu]
                </td>
              </tr>
            [#else]
