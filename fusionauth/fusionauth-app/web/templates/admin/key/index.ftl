              ...
              <tbody>
                [#list results![] as key]
                  ...
                  <tr>
                    ...
                    <td class="break-word">${properties.display(key, "name")}</td>
                    ...
                    <td class="action">
                      [@button.actionMenu]
                        [#if !shadowKey]
                          [@button.actionMenuItem href="edit/${key.id}" icon="edit" textKey="edit" color="blue"/]
                        [/#if]
                        [@button.actionMenuItem href="/ajax/key/view/${key.id}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true color="green" resizeDialog=true/]
                        ...
                        [#if key.type != "HMAC" && (key.publicKey?? || key.certificate??)]
                          [@button.actionMenuItem href="/admin/key/download/${key.id}" icon="download" textKey="download" color="purple"/]
                        [/#if]
                        [#if !shadowKey]
                          [@button.actionMenuItem href="/ajax/key/delete/${key.id}" icon="trash" textKey="delete" ajaxForm=true color="red"/]
                        [/#if]
                      [/@button.actionMenu]
                    </td>
                  </tr>
