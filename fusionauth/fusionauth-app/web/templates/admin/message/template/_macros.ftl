        ...
        <table id="localization-table" data-template="localization-template">
          ...
          <tbody>
            ...
            <tr data-locale="${locale}" data-template="${((messageTemplate.localizedTemplates(locale))!'')}">
              ...
              <td class="action">
                [@button.actionMenu]
                  [@button.actionMenuItem href="/ajax/message/template/validate-localization" icon="edit" textKey="edit"/]
                  [@button.actionMenuItem href="/ajax/message/template/preview" icon="search" textKey="view"/]
                  [@button.actionMenuItem href="/ajax/message/template/delete-localization" icon="trash" textKey="delete" class="delete-button"/]
                [/@button.actionMenu]
              </td>
            </tr>
            [/#list]
