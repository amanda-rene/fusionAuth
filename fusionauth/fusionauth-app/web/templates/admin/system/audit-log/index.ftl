          ...
          <table class="hover listing" data-sortable="false">
            ...
            [#list results![] as log]
              <tr>
                ...
                <td class="action">
                  [@button.iconLinkWithText icon="search" color="green" href="/ajax/system/audit-log/view/${log.id}" textKey="view" ajaxView=true ajaxWideDialog=true resizeDialog=true/]
                </td>
              </tr>
              [#else]
              <tr>
