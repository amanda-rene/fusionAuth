    ...
    [#if actions?? && actions?size > 0]
      ...
      [#list actions as action]
        ...
        <tr>
          ...
          <td class="action">
            [@button.actionMenu]
              [@button.actionMenuItem href="/ajax/user/modify-action/${action.id}" icon="edit" textKey="modify-action" ajaxForm=true ajaxWideDialog=true/]
              [@button.actionMenuItem href="/ajax/user/cancel-action/${action.id}" icon="times" textKey="cancel-action" ajaxForm=true/]
            [/@button.actionMenu]
          </td>
        [/#if]
      </tr>
          ...
          <td class="action">
            [@button.actionMenu]
              [#if application.active && !readOnly]
                ...
                [@button.actionMenuItem href="/admin/user/registration/edit/${user.id}/${registration.applicationId}?tenantId=${user.tenantId}" icon="edit" textKey="edit-registration"/]
              [/#if]
              [@button.actionMenuItem href="/ajax/user/registration/view/${user.id}/${registration.applicationId}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true/]
              [#if !readOnly]
                [#if ftlCurrentUser.id != user.id || registration.applicationId != fusionAuthId]
                  [@button.actionMenuItem href="/ajax/user/registration/delete/${user.id}/${registration.applicationId}" icon="trash" textKey="delete-registration" ajaxForm=true/]
                  [#if application.verifyRegistration && !registration.verified && user.email??]
                    [@button.actionMenuItem href="/ajax/user/registration/resend-verification/${user.id}/${registration.applicationId}?tenantId=${user.tenantId}" icon="envelope" textKey="resend-verification"ajaxForm=true/]
                  [/#if]
                [/#if]
              [/#if]
            [/@button.actionMenu]
...
<table class="hover">
  ...
  <tbody>
      ...
      <tr>
        ...
        <td class="action">
          [@button.actionMenu]
            [@button.actionMenuItem href="/ajax/identity-provider/link/view?userId=${user.id}&identityProviderId=${idpLink.identityProviderId}&identityProviderUserId=${idpLink.identityProviderUserId?url}&tenantId=${user.tenantId}" icon="search" textKey="view" ajaxView=true ajaxForm=false ajaxWideDialog=true/]
            [@button.actionMenuItem href="/ajax/identity-provider/link/delete?userId=${user.id}&identityProviderId=${idpLink.identityProviderId}&identityProviderUserId=${idpLink.identityProviderUserId?url}&tenantId=${user.tenantId}" icon="trash" textKey="remove-user-link" ajaxForm=true ajaxWideDialog=false/]
          [/@button.actionMenu]
        </td>
      </tr>
    [#else]
  ...
  <tbody>
    [#if user.memberships?? && user.memberships?size gt 0]
      ...
      <tr>
        ...
        <td class="action">
          [@button.actionMenu]
            [@button.actionMenuItem href="/ajax/group/member/view?userId=${user.id}&groupId=${membership.groupId}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true/]
            [@button.actionMenuItem href="/ajax/group/member/remove?userId=${user.id}&groupId=${membership.groupId}&bulkManagement=false" icon="trash" textKey="remove-membership" ajaxForm=true ajaxWideDialog=true/]
          [/@button.actionMenu]
        </td>
      </tr>
      [/#list]
  ...
  <table class="hover">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td class="action">
            [#if !readOnly]
              [@button.iconLinkWithText href="/ajax/user/two-factor/disable?methodId=${method.id?url}&userId=${user.id}" icon="trash" color="red" textKey="disable-two-factor" ajaxForm=true ajaxWideDialog=true/]
            [/#if]
          </td>
        </tr>
        [#else]
  ...
  <table class="hover">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td class="action">
            [@button.actionMenu]
              [@button.actionMenuItem href="/ajax/user/webauthn/view/${cred.id}?tenantId=${cred.tenantId}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true/]
              [#if !readOnly]
                [@button.actionMenuItem href="/ajax/user/webauthn/delete/${cred.id}?userId=${cred.userId}&tenantId=${cred.tenantId}" icon="trash" textKey="delete-webauthn-passkey" ajaxForm=true ajaxWideDialog=true/]
              [/#if]
            [/@button.actionMenu]
          </td>
        </tr>
  ...
  <tbody>
    [#if refreshTokens?has_content]
      ...
      <tr>
        ...
        [#if !readOnly]
        <td class="action">
          [@button.iconLinkWithText href="/ajax/user/refresh-token/delete/${refreshToken.id}?tenantId=${user.tenantId}" icon="trash" textKey="delete-session" color="red" ajaxForm=true/]
        </td>
        [/#if]
      </tr>
      [/#list]
      ...
      [#list families![] as family]
        [#list family.members as member]
          ...
          <tr>
            ...
            <td class="action">[@button.iconLinkWithText href="${memberUser.id}?tenantId=${memberUser.tenantId}" icon="address-card-o" textKey="manage" color="purple"/]</td>
          </tr>
        [/#list]
      [/#list]
    [#else]
          ...
          [@button.actionMenu]
            [#if userConsent.status == 'Active']
              [#if userConsent.consent.values?has_content]
                ...
                [@button.actionMenuItem href="/ajax/user/consent/edit/${userConsent.id}" icon="edit" textKey="edit-consent" ajaxView=false ajaxForm=true/]
              [/#if]
              [@button.actionMenuItem href="/ajax/user/consent/revoke/${userConsent.id}" icon="minus-circle" textKey="revoke" ajaxView=false ajaxForm=true/]
            [#else]
              [@button.actionMenuItem href="/ajax/user/consent/unrevoke/${userConsent.id}" icon="undo" textKey="unrevoke" ajaxView=false ajaxForm=true/]
            [/#if]
          [/@button.actionMenu]
        </td>
      </tr>
