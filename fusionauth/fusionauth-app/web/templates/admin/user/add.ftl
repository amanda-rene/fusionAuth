...
[@layout.html]
  ...
  [/@layout.head]
  [@layout.body]
    [@layout.pageForm action="add" method="POST" id="user-form" includeSave=true includeCancel=true cancelURI="/admin/user/" breadcrumbs={"/admin/user/": "users", "/admin/user/add": "add"}]
      [#if tenantId??]
