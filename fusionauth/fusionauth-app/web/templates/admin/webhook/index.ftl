            ...
            <table class="hover listing" data-sortable="false">
              ...
              <tbody>
                [#list results![] as webhook]
                  <tr>
                    <td class="break-word">${webhook.url}</td>
                    ...
                    <td class="action">
                      [@button.actionMenu]
                        [@button.actionMenuItem href="edit/${webhook.id}" icon="edit" textKey="edit"/]
                        [@button.actionMenuItem href="test/${webhook.id}" icon="exchange" textKey="test"/]
                        [@button.actionMenuItem href="/ajax/webhook/view/${webhook.id}" icon="search" textKey="view" ajaxView=true ajaxWideDialog=true resizeDialog=true/]
                        [@button.actionMenuItem href="/ajax/webhook/delete/${webhook.id}" icon="trash" textKey="delete" ajaxForm=true/]
                      [/@button.actionMenu]
                    </td>
                  </tr>
                [#else]
