...
[#--Email Template Settings--]
 ...
 [@properties.rowEval nameKey="passwordValidationRules.breachDetection.enabled" object=tenant propertyName="passwordValidationRules.breachDetection.enabled"/]
  ...
  [@properties.table]
    ...
    [@properties.row nameKey="lambdaConfiguration.loginValidationId" value=properties.display(tenant, "lambdaConfiguration.loginValidationId") /]
  [/@properties.table]
  ...
  <table>
    ...
    [#list [
      ...
      "rememberOAuthScopeConsentChoice",
